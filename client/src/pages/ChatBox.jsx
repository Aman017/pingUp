...
import { addMessages, resetMessages } from '../features/messages/messagesSlice';
...
return ()=>{
  ...
  return user && (
    <div className=' flex flex-col h-screen'>
      ...
      <div className='px-4'>
        <div className='flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border  border-orange-200 shadow rounded-full mb-5'>
          ...
          <label htmlFor="image">
            {
              image ? <img src={URL.createObjectURL(image)} className='h-8 rounded' alt="" /> : <ImageIcon className='size-7 cursor-pointer text-gray-400'/>
            }
