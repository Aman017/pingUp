    ...
    const handleMediaUpload = (e) => {
        ...
        if (file) {
            if (file.type.startsWith('video')) {
                ...
                // before loading the video it is adding the meta data
                video.preload = 'metadata';
                video.onloadedmetadata = () => {
                    //after that we add it in onloaddedmetadata and revome the url from video src so video will not the display on webpage
